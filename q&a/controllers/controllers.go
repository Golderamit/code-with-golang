	...
	graphql.ObjectConfig{
		...
		Fields: graphql.Fields{
			/* Get (read) single product by id
			   http://localhost:5432/graphql?query={questions(id:1){first_object,second_object}}
			*/
			...
			/* Get (read) product list
			   http://localhost:5432/graphql?query={list{id}}
			*/
			"list": &graphql.Field{
...
var mutationType = graphql.NewObject(graphql.ObjectConfig{
	...
	Fields: graphql.Fields{
		...
		http://localhost:5432/product?query=mutation+_{create(name:"asd"){id,name,info,price}}
		*/
		...
		/* Update product by id
		   http://localhost:5432/product?query=mutation+_{update(id:1,price:3.95){id,name,info,price}}
		*/
		...
		/* Delete product by id
		   http://localhost:5432/product?query=mutation+_{delete(id:1){id,name,info,price}}
		*/
